    ...
    const JsonData = Data.map((elem) => {
      ...
      return {
        ...
        billing_is_same_as_consignee:
          consigneeDetails.billing_is_same_as_consignee,
        billing_full_name: consigneeDetails.billing_full_name,
        billing_phone: consigneeDetails.billing_phone,
        billing_email: consigneeDetails.billing_email,
        billing_address: consigneeDetails.billing_address,
        billing_landmark: consigneeDetails.billing_landmark,
        billing_pincode: consigneeDetails.billing_pincode,
        billing_city: consigneeDetails.billing_city,
        billing_state: consigneeDetails.billing_state,
        billing_country: consigneeDetails.billing_country,
        pickup_location_name: pickupDetails.pickup_location_name,
        ...
        pickup_location_code: pickupDetails.pickup_location_code,
        pickup_account_id: pickupDetails.pickup_account_id,
        isOtherField: pickupDetails.isOtherField,
        isActive: pickupDetails.isActive,
