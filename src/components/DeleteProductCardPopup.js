...
import { useDeleteProductMutation } from "../Redux/Action";
import { toast } from "react-toastify";

const DeleteCardPopup = ({ deletePopup, setDeletePopup, deletePayload }) => {
  const [deleteProduct, { isLoading, isSuccess, data, isError, error }] =
